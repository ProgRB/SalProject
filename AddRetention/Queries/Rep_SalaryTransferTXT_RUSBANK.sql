select to_char((select date_cartulary from {1}.cartulary where cartulary_id=:p_cartulary_id), 'dd/mm/yyyy')||' заработная плата за '||to_char((select date_cartulary from {1}.cartulary where cartulary_id=:p_cartulary_id), 'Month', 'nls_date_language=Russian')  a, 
